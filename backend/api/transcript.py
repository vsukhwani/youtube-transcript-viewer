...
from api.utils.transcript_utils import get_transcript_text
    ...
    def do_POST(self):
        ...
        try:
            ...
            try:
                ...
                self._send_success({"transcript": transcript_text})
                ...
                self._send_error(404, "Transcript not available for this video")
